...
<%--  下面这个用chatgpt自己加的，链接下面自己加的下拉框（失败了，这个就留在这里做个证明吧，我则曾为前端努力过）--%>
    <link rel="stylesheet" type="text/css" href="/css/testcss1.css">
    ...
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
            ...
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <a href="/admin/other/111"target="_blank">博客背景</a>
                    <a href="/admin/other/222"target="_blank">博客技术</a>
                    <a href="/admin/other/333"target="_blank">博客初心</a>
...
<%--                </li>--%>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
<%--             把下面这个前端功能注释掉，后端没动，就不让用户自己添加页面了，太麻烦了
    ...
    <div class="layui-footer">
        <!-- 底部固定区域 -->
        © <a href="http://localhost:8080/admin">转转博客</a>有问题欢迎联系开发者 yyfqqemail@qq.com，博主免费回答大家日常问题，解决开发问题
    </div>
</div>
